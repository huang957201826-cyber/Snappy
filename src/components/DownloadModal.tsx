...
import { X, ShieldCheck, Copy, Check, Sparkles } from 'lucide-react';
      ...
      >
        ...
        <div className="mb-6 bg-slate-50 p-4 sm:p-5 rounded-2xl border border-slate-200">
          ...
          <p className="text-xs text-slate-600 leading-relaxed">
            点击下载按钮后将跳转到 GitHub Release 资产地址，浏览器会显示真实下载状态。
          </p>
        ...
        <div className="p-4 rounded-2xl bg-blue-50/80 border border-blue-200 mb-6 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[11px] text-slate-600 block">当前为 Windows x64 v0.1.1 Closed Pilot</span>
            </div>
          </div>
          <a
            href="https://github.com/huang957201826-cyber/Snappy/releases/tag/v0.1.1"
            target="_blank"
        ...
        <a
          ...
          className="w-full py-3.5 rounded-full bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm transition-all duration-200 cursor-pointer shadow-md hover:scale-[1.01] active:scale-95 text-center block"
        >
          下载 {version.name}
        </a>
      </div>
